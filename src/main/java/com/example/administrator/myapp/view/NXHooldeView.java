package com.example.administrator.myapp.view;
...
/**
 * Created by zhaoxichao-pc on 2016/7/10.
 */
public class NXHooldeView extends TextView implements ValueAnimator.AnimatorUpdateListener {
    ...
    public void startBeizerAnimation() {
        ...
        anim.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animator) {
                if (nXanimatioListener!=null) {
                    nXanimatioListener.startChangeProductNum();
    ...
    public interface NXanimatioListener{
        void startChangeProductNum();
    }

    public void setnXanimatioListener(NXanimatioListener nXanimatioListener) {
        this.nXanimatioListener = nXanimatioListener;
    }
    public NXanimatioListener nXanimatioListener;
    @Override
